...
import { CoachTeamSeasons, Conference, Rankings, StatisticRankings, Teams, TeamSeasonConferences } from '@/types/cbb';
...
async function getConference({params, searchParams}): Promise<Partial<Conference>> {
  const conference_id = params.conference_id;
...
type Data = {
  team_season_conferences: CoachTeamSeasons | {};
  teams: Teams | {};
...
async function getData({params, searchParams}): Promise<Data> {
  ...
  return { team_season_conferences, teams, cbb_statistic_rankings, cbb_rankings };
};
...
export default async function Page({ params, searchParams }) {
  ...
  return (
    <ReduxWrapper team_season_conferences = {data.team_season_conferences} teams = {data.teams} cbb_statistic_rankings = {data.cbb_statistic_rankings} cbb_rankings = {data.cbb_rankings} >
      <HeaderClientWrapper>
