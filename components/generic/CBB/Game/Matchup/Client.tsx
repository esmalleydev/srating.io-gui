  ...
  const rankRows = [
    {
      ...
      'away': (awayRankings && awayRankings.composite_rank) || '-',
      'home': (homeRankings && homeRankings.composite_rank) || '-',
      'awayCompareValue': (awayRankings && awayRankings.composite_rank) || Infinity,
      'homeCompareValue': (homeRankings && homeRankings.composite_rank) || Infinity,
      'favored': 'lower',
      'showDifference': true,
      'precision': 0,
    },
    {
      ...
      'awayRank': (awayRankings && awayRankings.elo_rank),
      'homeRank': (homeRankings && homeRankings.elo_rank),
      'favored': 'higher',
      'showDifference': true,
      'precision': 0,
    },
    {
      'name': 'NET',
      'title': 'NET',
      'away': (awayRankings && awayRankings.net_rank) || '-',
      'home': (homeRankings && homeRankings.net_rank) || '-',
      'awayCompareValue': (awayRankings && awayRankings.net_rank) || Infinity,
      'homeCompareValue': (homeRankings && homeRankings.net_rank) || Infinity,
      'favored': 'lower',
      'showDifference': true,
      'precision': 0,
    },
    {
      'name': 'KP',
      'title': 'Kenpom',
      'away': (awayRankings && awayRankings.kenpom_rank) || '-',
      'home': (homeRankings && homeRankings.kenpom_rank) || '-',
      'awayCompareValue': (awayRankings && awayRankings.kenpom_rank) || Infinity,
      'homeCompareValue': (homeRankings && homeRankings.kenpom_rank) || Infinity,
      'favored': 'lower',
      'showDifference': true,
      'precision': 0,
    },
    {
      'name': 'SRS',
      'title': 'SRS',
      'away': (awayRankings && awayRankings.srs_rank) || '-',
      'home': (homeRankings && homeRankings.srs_rank) || '-',
      'awayCompareValue': (awayRankings && awayRankings.srs_rank) || Infinity,
      'homeCompareValue': (homeRankings && homeRankings.srs_rank) || Infinity,
      'favored': 'lower',
      'showDifference': true,
      'precision': 0,
    },
    {
      'name': 'AP',
      'title': 'AP',
      'away': (awayRankings && awayRankings.ap_rank) || '-',
      'home': (homeRankings && homeRankings.ap_rank) || '-',
      'awayCompareValue': (awayRankings && awayRankings.ap_rank) || Infinity,
      'homeCompareValue': (homeRankings && homeRankings.ap_rank) || Infinity,
      'favored': 'lower',
      'showDifference': true,
      'precision': 0,
    },
    {
      'name': 'Coaches',
      'title': 'Coaches Poll',
      'away': (awayRankings && awayRankings.coaches_rank) || '-',
      'home': (homeRankings && homeRankings.coaches_rank) || '-',
      'awayCompareValue': (awayRankings && awayRankings.coaches_rank) || Infinity,
      'homeCompareValue': (homeRankings && homeRankings.coaches_rank) || Infinity,
      'favored': 'lower',
      'showDifference': true,
      'precision': 0,
    },
