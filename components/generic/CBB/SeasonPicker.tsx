...
const SeasonPicker = ({ selected, actionHandler }) => {
  ...
  const options = [
    ...
    {'value': 2017, 'label': '2016 - 2017'},
    {'value': 2016, 'label': '2015 - 2016'},
    {'value': 2015, 'label': '2014 - 2015'},
    {'value': 2014, 'label': '2013 - 2014'},
    {'value': 2013, 'label': '2012 - 2013'},
    {'value': 2012, 'label': '2011 - 2012'},
    {'value': 2011, 'label': '2010 - 2011'},
  ];
