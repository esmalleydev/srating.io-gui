...
const PublicDraftGroups = (
  ...
  return (
    <div>
      <Typography type = 'h6'>Open public draft groups</Typography>
      <Paper style={{ padding: 16 }}>
        <Typography type = 'caption' style = {{ color: theme.text.secondary }}>Join one of these groups to draft a team of players!</Typography>
        {
          free_rows.length ?
            <>
        ...
        }
        {
          !paid_rows.length && !free_rows.length ?
            <div style = {{ padding: 16, display: 'flex', justifyContent: 'center', alignItems: 'center', fontStyle: 'italic', color: theme.text.secondary }}>
              ...
              <Typography type = 'body1' style = {{ color: theme.text.secondary }}>No public draft groups!</Typography>
            </div>
            : ''
        }
      </Paper>
...
export default PublicDraftGroups;
